    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row no-gutters">
                ...
                <div class="col-md-3">
                    <form method="POST" action="<?php echo site_url('C_laporan/laporan_kegiatan') ?>">
                        <table>
                            <tr>
                                <div class="col-md">
                ...
                <div class="col-md-3">
                    <form method="POST" action="<?php echo site_url('C_laporan/laporan_data_anggota') ?>">
                        <table>
                            <tr>
                                <div class="col-md">
                                    <div class="card card-solid">
                                        <div class="card-header bg-danger">
                                            <div class="card-title">Laporan Data Anggota</div>
                                        </div>
                                        <div class="card-body">
                                            <div class="col-xs">
                                                <button type="submit" class="btn btn-block btn-dark"><i class="fa fa-print"></i> Cetak</button>
                ...
                <div class="col-md-3">
                    <form method="POST" action="<?php echo site_url('C_laporan/laporan_data_petugas') ?>">
                        <table>
                            <tr>
                                <div class="col-md">
                                    <div class="card card-solid ">
