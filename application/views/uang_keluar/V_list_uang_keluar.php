    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <a href="<?= site_url('C_uang_keluar/add_uang_keluar') ?>" class="btn btn-primary btn-flat">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center" width="100px">
                                    <a class="btn btn-xs btn-success" href="<?= site_url('C_uang_keluar/edit_uang_keluar/' . $d->id_uang_keluar) ?>">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-xs btn-danger" href="javascript:void(0)" onclick="hapus('<?= $d->id_uang_keluar ?>','<?= $d->keterangan ?>')">
...
<div class="modal fade" id="hapus_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo site_url('C_uang_keluar/delete_uang_keluar') ?>">
