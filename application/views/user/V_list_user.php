    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <a href="<?= site_url('C_admin/add_user') ?>" class="btn btn-primary btn-flat">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center" width="100px">
                                    <a class="btn btn-xs btn-success" href="<?= site_url('C_admin/edit_user/' . $d->id_user) ?>">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-xs btn-danger" href="javascript:void(0)" onclick="hapus('<?= $d->id_user ?>','<?= $d->nama_user ?>')">
